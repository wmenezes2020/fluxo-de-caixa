...
<head>
  ...
  <title>Nova Venda - Fluxo de Caixa - MINSOFT</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Nova Venda</a>
        <!-- User -->
          ...
          <input type="hidden" name="nova_venda" value="1" />
            ...
            <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-control-label" for="id_cliente">Cliente</label>
                        <select id="id_cliente" class="form-control form-control-alternative" name="id_cliente">
                          <?php foreach($jsonClientes as $cliente) { ?>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="number" id="unid" class="form-control form-control-alternative" name="unid" placeholder="0" value="1" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="number" id="valor" class="form-control form-control-alternative" name="valor" placeholder="0" readonly />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-control-label" for="total">Valor total da Venda</label>
