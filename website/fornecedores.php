...
<head>
  ...
  <title>Fornecedores - Fluxo de Caixa - MINSOFT</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Fornecedores</a>
        <!-- User -->
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="cad-fornecedor.php" class="btn btn-sm btn-primary">Cadatsrar Novo</a>
                </div>
              </div>
            </div>
